...
import { ConnectGetCapabilityInfo, ConnectGetDeviceInfo, ConnectGetProtocolInfo, ConnectGetSupportFunctionTable1, ConnectRetCapabilityInfo, ConnectRetDeviceInfo, ConnectRetProtocolInfo, ConnectRetSupportFunctionTable1 } from "./connect";
...
export const table1list: Partial<Record<Table, typeof AbstractCommand>> = {
    ...
    [Table.CONNECT_GET_DEVICE_INFO]: ConnectGetDeviceInfo,
    [Table.CONNECT_RET_DEVICE_INFO]: ConnectRetDeviceInfo,
