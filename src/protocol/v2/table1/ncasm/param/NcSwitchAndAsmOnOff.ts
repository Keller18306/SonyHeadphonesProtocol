...
export class NcAsmSetParamNcSwitchAndAsmOnOff extends BasicCommand {
    public type: NcAsmInquiredType = NcAsmInquiredType.NC_MODE_SWITCH_AND_ASM_ON_OFF;

    public static fromBuffer(reader: ReadBuffer): NcAsmSetParamNcSwitchAndAsmOnOff {
        ...
        return new NcAsmSetParamNcSwitchAndAsmOnOff(
            noiseCancel,
            ncValue, ambientSoundMode, ambientSound,
            changeStatus
        );
    }
